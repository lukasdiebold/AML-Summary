...
\begin{itemize}
    ...
    \item \textbf{Neuroimaging / fMRI.} (Briefly noted on the slides) GPs provide non-parametric spatial priors and can interpolate neural activity with quantified uncertainty, though detailed derivations are beyond the summary’s scope.
\end{itemize}
