...
\begin{itemize}
    ...
    $$
    where $X'$ is the training data and $X''$ is the test data, so thiw is the risk where $\theta$ is conditioned on the training data (trained the model).
...
\begin{itemize}
    \item Our perception of “our world” / reality is mediated by data of senses / sensors.
    \item Our data are influenced by chance.
    \item Creatures interpret selected aspects of reality by hypotheses to "survive and reproduce"
    \item Data and hypotheses define models to enable judgements, decisions and actions.
    \item AI / ML: Algorithms define relations of data and hypotheses, e.g., they select models !
\end{itemize}
